...
export default function PythonCodeRunner({ initialCode, height = 560 }: Props) {
    ...
    <div className="w-full">
      <div className="flex gap-4">
        <div className="flex-1 border-2 border-b-4 rounded-xl overflow-hidden">
          <div className="px-3 py-2 bg-slate-50 border-b text-xs font-bold tracking-wide text-slate-500">Python Source</div>
          <textarea
